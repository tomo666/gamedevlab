...
<br/><div className={styles.baloon}>パンッ！（ハナちょうちんが割れる音）</div><br/>
...
| <img src={amtjp} style={{width: 200}} alt="amtjp" /> | <img src={amtjp_font_sample} style={{width: 300}} alt="amtjp_font_sample" /> |
|---|---|
|amtjp|ゲーム内サンプル|
